...
export const DICT = {
  ...
  btn_modo_bolso: { pt: 'Modo bolso (tela travada)', en: 'Pocket mode (screen locked)', es: 'Modo bolsillo (pantalla bloqueada)' },
  pocket_gravando: { pt: 'Gravando', en: 'Recording', es: 'Grabando' },
  pocket_segure_destravar: { pt: 'Segure para destravar', en: 'Hold to unlock', es: 'Mantenga para desbloquear' },
  pocket_hint: { pt: 'Tela travada (preta para poupar bateria). A gravação continua no bolso.', en: 'Screen locked (black to save battery). Recording continues in your pocket.', es: 'Pantalla bloqueada (negra para ahorrar batería). La grabación continúa en el bolsillo.' },
  btn_importar_audio: { pt: 'Importar áudio gravado no celular', en: 'Import audio recorded on your phone', es: 'Importar audio grabado en el celular' },
  hint_importar_audio: { pt: 'Grave no app de voz do celular (continua com a tela bloqueada) e importe o arquivo aqui.', en: 'Record in your phone voice app (keeps going with the screen locked) and import the file here.', es: 'Grabe en la app de voz del celular (sigue con la pantalla bloqueada) e importe el archivo aquí.' },
  msg_audio_importado: { pt: 'Áudio importado.', en: 'Audio imported.', es: 'Audio importado.' },
  msg_erro_importar_audio: { pt: 'Não foi possível importar o áudio.', en: 'Could not import the audio.', es: 'No se pudo importar el audio.' },
  btn_revisar_excel: { pt: 'Revisar dados e exportar', en: 'Review data and export', es: 'Revisar datos y exportar' },  titulo_revisao: { pt: 'Revisão dos dados', en: 'Data review', es: 'Revisión de los datos' },
  ...
  lbl_trial_file: { pt: 'Mapa do ensaio (Excel, opcional)', en: 'Trial map (Excel, optional)', es: 'Mapa del ensayo (Excel, opcional)' },
  msg_trial_carregado: { pt: 'Mapa carregado: {{t}} tratamentos, {{r}} repetições ({{id}}).', en: 'Map loaded: {{t}} treatments, {{r}} replications ({{id}}).', es: 'Mapa cargado: {{t}} tratamientos, {{r}} repeticiones ({{id}}).' },
  msg_trial_erro: { pt: 'Não foi possível ler o arquivo do ensaio (segue normal sem o mapa).', en: 'Could not read the trial file (continuing without the map).', es: 'No se pudo leer el archivo del ensayo (sigue sin el mapa).' },
  lbl_boxplots: { pt: 'Boxplots por praga (dispersão por tratamento)', en: 'Boxplots by pest (spread by treatment)', es: 'Boxplots por plaga (dispersión por tratamiento)' },
  btn_boxplot: { pt: 'Boxplot', en: 'Boxplot', es: 'Boxplot' },
  btn_fechar: { pt: 'Fechar', en: 'Close', es: 'Cerrar' },
  lbl_valor: { pt: 'Valor', en: 'Value', es: 'Valor' },
